...
// const Footer = () => {
//     return (
//         <footer className="bg-gradient-to-b from-neutral-800 to-neutral-900 text-white shadow-lg mt-auto">
...
//                         <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">Fitness Total Gym</span>
//                     </Link>
...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-b from-neutral-800 to-neutral-900 text-white shadow-lg w-full mt-4">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <Link href="/" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                        <Image src="/logo-gym.png" width={40} height={50} className="h-8 rounded-lg" alt="Fitness Total Gym Logo" />
